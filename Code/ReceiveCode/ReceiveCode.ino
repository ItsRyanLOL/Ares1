...
/* ////////////////////////////////
This sketch finds the heading (degrees) of the transmitting beacon. For example, if the receiver is due west of the beacon, this sketch
will return a heading of 270 degrees.
...
void i2cPrint()
{
  Serial.println("Master bids his will upon us");
